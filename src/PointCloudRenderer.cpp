...
void PointCloudRenderer::Delete()
{
    ...
    glDeleteBuffers(1, &VertexBufferIDBox);
    glDeleteBuffers(1, &VertexBufferTex);
    ...
    bool useTestPointClouds)
{
    ...
    //    while (i<ssbo_CPUMEM.last_index)
    //    {
...
void PointCloudRenderer::Render(int width, int height)
{
    ...
    glDrawArraysInstanced(GL_POINTS, 0, 1, m_drawArraySize);
    ...
    //std::cout << scene->getTileProgress() << std::endl;
