...
//torso w/o clavicles
	...
	rect_pos.push_back(vec3(-1.0, -1.0, 0.0));
	rect_pos.push_back(vec3(1.0, -1.0, 0.0));
	rect_pos.push_back(vec3(-1.0, 1.0, 0.0));
	rect_pos.push_back(vec3(1.0, 1.0, 0.0));
	rect_tex.push_back(vec2(0.0, 0.0));
	rect_tex.push_back(vec2(1.0, 0.0));
	rect_tex.push_back(vec2(0.0, 1.0));
	rect_tex.push_back(vec2(1.0, 1.0));
	...
	rect_pos2.push_back(vec3(-1.0, -1.0, 0.0));
	rect_pos2.push_back(vec3(1.0, -1.0, 0.0));
	rect_pos2.push_back(vec3(-1.0, 1.0, 0.0));
	rect_pos2.push_back(vec3(1.0, 1.0, 0.0));
	rect_tex2.push_back(vec2(0.0, 0.0));
	rect_tex2.push_back(vec2(1.0, 0.0));
	rect_tex2.push_back(vec2(0.0, 1.0));
	rect_tex2.push_back(vec2(1.0, 1.0));
